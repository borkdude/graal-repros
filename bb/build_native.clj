...
(p/shell (fs/file (System/getenv "GRAALVM_HOME") "bin" "native-image")
         ...
         "--initialize-at-build-time=clojure,my,org.xml.sax,com.sun.tools.doclint,com.sun.tools.javac.parser.Tokens$TokenKind,com.sun.tools.javac.parser.Tokens$Token$Tag"
